    ...
    <li class="film-details__comment">
      ...
      <div>
        ...
        <p class="film-details__comment-info">
          ...
          <span class="film-details__comment-day">${comment.days} days ago</span>
      ...
      <form class="film-details__inner" action="" method="get">
        <div class="form-details__top-container">
          ...
          <div class="film-details__info-wrap">
            <div class="film-details__poster">
              <img class="film-details__poster-img" src="${this._film.posterURL}" alt="">
    
              <p class="film-details__age">${this._film.ageRestriction}</p>
            </div>
            ...
            <div class="film-details__info">
              <div class="film-details__info-head">
                <div class="film-details__title-wrap">
                  ...
                  <p class="film-details__title-original">${this._film.titleOriginal}</p>
                </div>
              ...
              <table class="film-details__table">
                ...
                <tr class="film-details__row">
                  ...
                  <td class="film-details__cell">
                    ${Array.from(this._film.genres).map((item) => `
        ...
        <div class="form-details__bottom-container">
          <section class="film-details__comments-wrap">
            ...
            ${(this._comments.length) ? this._getComments(this._comments) : ``}
